...
<template>
  <section class="[box-shadow:_inset_0_-1px_rgba(5,_30,_86,_0.16)]">
    ...
    >
      ...
      <h2
        class="text-darkBlue font-bold mt-8 text-2xl lg:text-[32px] lg:leading-[48px]"
      >
        General Information
      </h2>
      ...
      <p class="text-darkBlue text-base font-normal lg:text-2xl">
        ...
        it may also include other information such as your IP address, Online
        identifiers or preferences and interests.
      </p>
      ...
      <p class="text-darkBlue text-base font-normal lg:text-2xl">
        ...
        trade union membership, genetic data, biometric data. As well as, data
        concerning health, a person’s sex life; and a person’s sexual
        orientation. In order to lawfully process special category data, it is
      ...
      <p class="text-darkBlue text-base font-normal lg:text-2xl">
        ...
        <span class="block"
          >Knyahyni Olʹhy, L’viv, L’vivs’ka oblast, 79000</span
        >
      </p>
      ...
      <p class="text-darkBlue text-base font-normal lg:text-2xl mt-4">
        ...
        us by email at support@scanwizard.app. For your protection and the
      ...
      <p class="text-darkBlue text-base font-normal lg:text-2xl">
        ...
        purposes of the processing, as well as the different probabilities of
        occurrence and the level of threat to the rights and freedoms of natural
      ...
      <p class="text-darkBlue text-base font-normal lg:text-2xl">
        ...
        the APP or if you have given us your consent.
      </p>
      ...
      <p class="text-darkBlue text-base font-normal lg:text-2xl">
        ...
        law); in the latter case, the data will be deleted once these reasons no
        longer apply.
      </p>
      ...
      <p class="text-darkBlue text-base font-normal lg:text-2xl">
        ...
        personal data. However, failure to provide the data could result in you
      ...
      <p class="text-darkBlue text-base font-normal lg:text-2xl mt-4">
        ...
        request to us in writing to support@scanwizard.app.
      </p>
      ...
      <p class="text-darkBlue text-base font-normal lg:text-2xl mt-4">
        ...
        (principle of data minimization). As such we have made sure that as
      ...
      <p class="text-darkBlue text-base font-normal lg:text-2xl mt-4">
        ...
        whether and, if so, to what extent it is stored by us and/or transmitted
        to third parties.
      </p>
      ...
      <p class="text-darkBlue text-base font-normal lg:text-2xl">
        ...
        collected in two ways, that is directly when you for example volunteer
        it to us or automatically for example when you install and use our APP.
      </p>
      ...
      <p class="text-darkBlue text-base font-normal lg:text-2xl">
        ...
        stop receiving push messages at any time via the device settings of your
        device.
      </p>
      ...
      <p class="text-darkBlue text-base font-normal lg:text-2xl">
        ...
        via the Settings/Notifications/ options of your device; however, this
        means that our APP may not function as intended.
      </p>
      ...
      <p class="text-darkBlue text-base font-normal lg:text-2xl">
        ...
        of your request will be deleted after completion. In the course of the
        support you have requested, it may be necessary for you to provide us
        with some of your personal data so that we can fulfill our contractual
        obligations. The data transmitted in this context will be deleted after
      ...
      <p class="text-darkBlue text-base font-normal lg:text-2xl mt-4">
        ...
        collection, use and disclosure of their Personal Data for the Purposes.
      ...
      <p class="text-darkBlue text-base font-normal lg:text-2xl mt-4">
        ...
        visit action evaluation. The legal basis for the data processing is the
      ...
      <p class="text-darkBlue text-base font-normal lg:text-2xl mt-4">
        ...
        registration and the provision of downloads in the respective App store
      ...
      <p class="text-darkBlue text-base font-normal lg:text-2xl mt-4">
        ...
        and properties, APP crashes, advertising IDs information about your
        wireless and mobile network connection such as your service provider and
        signal strength; information about device sensors such as accelerometer,
      ...
      <p class="text-darkBlue text-base font-normal lg:text-2xl">
        ...
        information that include personal and non-personal data, such as
        advertising (or ad) identifiers, IP address regarding the delivery of
        advertisements and your interaction with them and/or other tracking
        technologies to enable and optimize its advertising procedure.
        Advertisers and third parties also may collect information about your
        activity on our APP, on devices associated with you, and on third-party
        sites and applications using tracking technologies. Tracking data
      ...
      <p class="text-darkBlue text-base font-normal lg:text-2xl mt-4">
        ...
        <a
          ...
          >Google Admob</a
        >
        service to display ads. Ads are personalized and based on the device you
        are using. You can disable this via the settings on your device. You can
        also opt out on the
        <a
          href="https://optout.aboutads.info/?lang=EN&c=2#!%2F"
          class="underline"
          >Digital Advertising Alliance (DAA)</a
        >
        if you wish not to receive targeted advertising. In addition, you may
        also choose to control targeted advertising you receive within
        applications by using the settings and controls on your devices.
      </p>
      ...
      <ul class="list-disc pl-8 mt-4">
        ...
        <li class="text-darkBlue text-base font-normal lg:text-2xl">
          ...
          prevention or detection of crime (in each case, subject to applicable
        ...
        <li class="text-darkBlue text-base font-normal lg:text-2xl">
          ...
          parties; (iii) to enforce our agreements with you; and (iv) to
          investigate, prevent, or take other action regarding illegal
          activities, suspected fraud or other misconduct.
        </li>
      </ul>
      ...
      <p class="text-darkBlue text-base font-normal lg:text-2xl">
        ...
        your account or contact us. For your protection and the protection of
        all of our users, we may ask you to provide proof of identity before we
        can answer the above requests.
      </p>
      ...
      <p class="text-darkBlue text-base font-normal lg:text-2xl">
        ...
        detailed above will be provided free of charge. However, in case of
        requests that are manifestly unfounded or excessive, in particular
        because of their repetitive character, we may charge a reasonable fee
